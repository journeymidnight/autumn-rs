...
mod wire_version_tests {
    ...
    /// The window is OPEN: `[43, 46]`, opened by raising the CEILING and
    /// widened by `MSG_GET_CLIENT_REGIONS`.
    ///
    ...
    fn the_client_window_is_open_and_the_floor_is_where_it_belongs() {
        ...
        assert_eq!(WIRE_VERSION, 46, "read this test's comment");
    }
